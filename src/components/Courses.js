...
const Courses = () => {
    ...
    return (
        <>
            <Header title={"Explore our course"} route={"Courses"}></Header>
            <section className="my-container section-gap grid grid-cols-1 lg:grid-cols-[4fr_8fr] xl:grid-cols-[3fr_9fr] gap-6">
                <div className="h-max rounded-lg shadow p-5 grid grid-cols-1 sm:grid-cols-2 gap-5 lg:content-gap-y bg-base-content/10">
                    {courses.map((course) => (
