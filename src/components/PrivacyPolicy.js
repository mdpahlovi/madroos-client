...
const PrivacyPolicy = () => {
    return (
        <section className="my-container section-gap flex flex-col gap-1">
            ...
            <h1 className="text-4xl font-bold mt-6">Interpretation and Definitions</h1>
            <h2 className="text-3xl font-bold mt-4">Interpretation</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold mt-4">Definitions</h2>
            ...
            <ul>
                ...
                <li className="list-disc ml-4">
                    <p>
                        <strong>Website</strong> refers to Madroos, accessible from{" "}
                        <a href="https://madroos-e.web.app/" rel="external nofollow noopener noreferrer" target="_blank">
                            https://madroos-e.web.app/
                        </a>
                    </p>
                </li>
                <li className="list-disc ml-4">
            ...
            <h1 className="text-4xl font-bold mt-6">Collecting and Using Your Personal Data</h1>
            <h2 className="text-3xl font-bold mt-4">Types of Data Collected</h2>
            <h3 className="text-2xl font-bold mt-2">Personal Data</h3>
            <p>
            ...
            <h3 className="text-2xl font-bold mt-2">Usage Data</h3>
            ...
            <h3 className="text-2xl font-bold mt-2">Tracking Technologies and Cookies</h3>
            <p>
            ...
            <p>
                ...
                You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the{" "}
                <a href="https://www.privacypolicies.com/blog/privacy-policy-template/#Use_Of_Cookies_Log_Files_And_Tracking" target="_blank" rel="noreferrer">
            ...
            <h2 className="text-3xl font-bold mt-4">Use of Your Personal Data</h2>
            ...
            <h2 className="text-3xl font-bold mt-4">Retention of Your Personal Data</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold mt-4">Transfer of Your Personal Data</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold mt-4">Delete Your Personal Data</h2>
            ...
            <h2 className="text-3xl font-bold mt-4">Disclosure of Your Personal Data</h2>
            <h3 className="text-2xl font-bold mt-2">Business Transactions</h3>
            <p>
            ...
            <h3 className="text-2xl font-bold mt-2">Law enforcement</h3>
            <p>
            ...
            <h3 className="text-2xl font-bold mt-2">Other legal requirements</h3>
            <p>The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
                <li className="list-disc ml-4">Comply with a legal obligation</li>
                <li className="list-disc ml-4">Protect and defend the rights or property of the Company</li>
                <li className="list-disc ml-4">Prevent or investigate possible wrongdoing in connection with the Service</li>
                <li className="list-disc ml-4">Protect the personal safety of Users of the Service or the public</li>
                <li className="list-disc ml-4">Protect against legal liability</li>
            </ul>
            <h2 className="text-3xl font-bold mt-4">Security of Your Personal Data</h2>
            <p>
            ...
            <h1 className="text-4xl font-bold mt-6">Detailed Information on the Processing of Your Personal Data</h1>
            <p>
            ...
            <h2 className="text-3xl font-bold mt-4">Usage, Performance and Miscellaneous</h2>
            ...
            <ul>
                <li className="list-disc ml-4">
                    ...
                    <p>
                        ...
                        <a href="https://www.google.com/intl/en/policies/privacy/" rel="external nofollow noopener noreferrer" target="_blank">
                            https://www.google.com/intl/en/policies/privacy/
                        </a>
                    </p>
                </li>
            </ul>
            <h1 className="text-4xl font-bold mt-6">Children's Privacy</h1>
            <p>
            ...
            <h1 className="text-4xl font-bold mt-6">Links to Other Websites</h1>
            <p>
            ...
            <h1 className="text-4xl font-bold mt-6">Changes to this Privacy Policy</h1>
